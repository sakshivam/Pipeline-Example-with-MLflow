...
def workflow():
    with mlflow.start_run():
        ...
        print("Taking input")
        download_run = mlflow.run(".", "taking_input",
        ...
        # step1_run =
        mlflow.run(".", "step1", parameters={"file_path": artifact})
        # process_run = mlflow.tracking.MlflowClient()
        # .get_run(step1_run.run_id)
        # data_path_uri = os.path.join(process_run.info.artifact_uri,
        #  "data_path")
