...
traindf_cleaned=replace_values_using_dict(traindf_cleaned, config['dict_for_clubbing'] )
traindf_cleaned=replace_values_using_dict(traindf_cleaned, config['dict_to_get_ordinal_features'] )
